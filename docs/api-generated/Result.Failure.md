...
Thrown when [errors](Result.md#ErrorOrResult.Result.Failure(ErrorOrResult.Error[]).errors 'ErrorOrResult\.Result\.Failure\(ErrorOrResult\.Error\[\]\)\.errors') is null\.
...
[System\.ArgumentNullException](https://learn.microsoft.com/en-us/dotnet/api/system.argumentnullexception 'System\.ArgumentNullException')  
Thrown when [errors](Result.md#ErrorOrResult.Result.Failure(System.Collections.Generic.List_ErrorOrResult.Error_).errors 'ErrorOrResult\.Result\.Failure\(System\.Collections\.Generic\.List\<ErrorOrResult\.Error\>\)\.errors') is null\.
...
[System\.ArgumentNullException](https://learn.microsoft.com/en-us/dotnet/api/system.argumentnullexception 'System\.ArgumentNullException')  
Thrown when [errors](Result.md#ErrorOrResult.Result.Failure_TOutput_(ErrorOrResult.Error[]).errors 'ErrorOrResult\.Result\.Failure\<TOutput\>\(ErrorOrResult\.Error\[\]\)\.errors') is null\.
...
[System\.ArgumentNullException](https://learn.microsoft.com/en-us/dotnet/api/system.argumentnullexception 'System\.ArgumentNullException')  
Thrown when [errors](Result.md#ErrorOrResult.Result.Failure_TOutput_(System.Collections.Generic.List_ErrorOrResult.Error_).errors 'ErrorOrResult\.Result\.Failure\<TOutput\>\(System\.Collections\.Generic\.List\<ErrorOrResult\.Error\>\)\.errors') is null\.
